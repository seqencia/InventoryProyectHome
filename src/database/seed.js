...
// ─── Entity Schemas (mirrors main.js) ────────────────────────────────────────
...
const SupplierSchema = new EntitySchema({
  name: 'Supplier', tableName: 'suppliers',
  columns: {
    id: { type: Number, primary: true, generated: true },
    name: { type: String },
    phone: { type: String, nullable: true },
...
const SaleDetailSchema = new EntitySchema({
  name: 'SaleDetail', tableName: 'sale_details',
  columns: {
    id: { type: Number, primary: true, generated: true },
    ...
    regalia_type: { type: String, nullable: true },
...
const StockEntrySchema = new EntitySchema({
  name: 'StockEntry', tableName: 'stock_entries',
  columns: {
    id: { type: Number, primary: true, generated: true },
    product_id: { type: Number, index: true },
    product_name: { type: String },
...
const ReturnDetailSchema = new EntitySchema({
  name: 'ReturnDetail', tableName: 'return_details',
  columns: {
    id: { type: Number, primary: true, generated: true },
...
const BonificacionPriceLogSchema = new EntitySchema({
  name: 'BonificacionPriceLog', tableName: 'bonificacion_price_logs',
  columns: {
    id: { type: Number, primary: true, generated: true },
...
const AppDataSource = new DataSource({
  ...
  database: DB_PATH,
  entities: [
    ProductSchema, CategorySchema, CustomerSchema, SaleSchema, SaleDetailSchema,
    SupplierSchema, StockEntrySchema, ReturnSchema, ReturnDetailSchema,
